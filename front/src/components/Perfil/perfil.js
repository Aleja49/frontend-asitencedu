...
import '../../styles/Perfil.css'; // Asegúrate de tener los estilos importados correctamente
...
const Perfil = () => {
  ...
  const handleSubmit = (event) => {
    ...
    // Aquí puedes manejar la lógica de perfil, como enviar los datos al backend
